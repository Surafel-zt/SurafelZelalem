...
e.grid(row=0, column=0, pady=10, padx=10, columnspan=3)
...
button_add = Button(root, text="+",padx=65, pady=30, command= button_add)
button_clear = Button(root, text="C",padx=30, pady=30, command= button_clear)
button_equal = Button(root, text="=",padx=65, pady=30, command= button_equal)
